    ...
    const[nombre, cambiarNombre] =useState({campo:"", valido: null});
        ...
        const saveData = () => {
            ...
            const nuevoDato = { firstName: nombre.campo, lastName: apellido.campo, docType: tipoDocumento.campo, docNumber: dni.campo,
                areaCode: codigoArea.campo, mobileNumber: telefono.campo, email: email.campo, form_id : 7
            };
    ...
    return (
        ...
        <div>
            <nav className="navbar  navbar-green"> 
                ...
                <button onClick={descargarDatos}  id="descargarDatosBtn">Descargar Datos</button>
                <button onClick={obtenerTodos}  id="subirDatos" className='botonCarga'>Subir Datos</button>
                </div>
            </nav>
        </div>
        ...
        <h1>Todos nuestros recursos provienen de donaciones particulares de personas como vos, que deciden apoyar campañas para seguir defendiendo el planeta.</h1>  */}
            ...
            <LABEL>
                ...
                Al presionar Enviar estaría aceptando nuestros <a href="https://www.greenpeace.org/colombia/terminos-y-condiciones/" target="_blank"  rel="noopener noreferrer">Términos y Condiciones</a>.
            </LABEL>
            </ContenedorTerminos>
